using CAsBouch.Logica.MetaHeuristicas;
using CAsBouch.Logica.MetaHeuristicas.BusquedaArmonica;
using CAsBouch.Logica.MetaHeuristicas.IteradosSA;
...
namespace CAsBouch
{
    public class AlgoritmoParalelo
    {
        ...
        public Solucion Ejecutar()
        {
            ...
            {
                case "ISA": miAlgoritmo = new ISA(int.Parse(parametros[0]), int.Parse(parametros[1]), n, k, v, t,
                                                  _tarSemilla, _tarCARequerido);
                    break;
                case "ISAE": miAlgoritmo = new ISAE(int.Parse(parametros[0]), int.Parse(parametros[1]), n, k, v, t,
                                                  _tarSemilla, _tarCARequerido);
                    break;
                case "GHSSA": miAlgoritmo = new GHSSA(int.Parse(parametros[0]), int.Parse(parametros[1]), n, k, v, t,
                                                  _tarSemilla, _tarCARequerido,
