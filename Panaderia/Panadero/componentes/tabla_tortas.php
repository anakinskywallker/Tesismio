...
<table class="table table-striped" style="cursor: pointer;">
    ...
    <tbody>
        ...
        $sql = " SELECT P.PRO_NOMBRE, L.NOMBRE,L.APELLIDOS, O.FECHA, O.CANTIDAD, O.PRODUCCION_ID FROM produccion O JOIN productos P ON O.PRO_ID = P.PRO_ID JOIN personal L ON O.PERSONAL_ID = L.PERSONAL_ID WHERE P.PRO_TIPO = 7 ORDER BY O.FECHA desc ";
